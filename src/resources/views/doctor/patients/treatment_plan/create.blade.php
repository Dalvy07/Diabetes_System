...
@section('title', 'Create Treatment Plan for ' . $patient->user->first_name . ' ' . $patient->user->last_name)

@section('content')
    <h1>Create Treatment Plan for {{ $patient->user->first_name }} {{ $patient->user->last_name }}</h1>
